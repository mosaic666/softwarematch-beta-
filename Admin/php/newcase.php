    ...
    <div id="main-wrapper">
		...
		<div id="container"> 
			<div id="right" style="background:#F7F8F9;min-height:600px;">
				<br><br>
				<h3><a href="newcase.php"> <b style="margin-left: 10px;">接受新的案件</b></a></h3><hr>
				<table class="table table-hover table-bordered table-responsive"  style="margin:auto;width: 80%">
				<thead>
				<tr>
				...
				$sql="select * from information where state='待接受' limit $offset,$pageSize";
				...
				while(@$row=mysql_fetch_assoc($result)){
					if($row['state']=="待接受"){
						...
						if(!empty($_GET['p'])){
							echo "<td style='text-align: center;width: 8%'><a href='all_content.php?id=".$row['id']."&p=".$_GET['p']."'>查看详情</a></td>";
							echo "<td style='text-align: center;width: 8%'><a href='delete3.php?id=".$row['id']."&p=".$_GET['p']."'>删除</a></td>";
						}else{
							echo "<td style='text-align: center;width: 8%'><a href='all_content.php?id=".$row['id']."'>查看详情</a></td>";
							echo "<td style='text-align: center;width: 8%'><a href='delete3.php?id=".$row['id']."'>删除</a></td>";
						}
						echo "</tr>";
					}
				}
				...
				$total_sql = "select COUNT(*) from information where state='待接受'";
				...
				$page_banner.="<form action='newcase.php' method='get'>";
