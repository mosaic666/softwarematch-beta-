...
<body data-spy="scroll">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a  style="font-size:16px;" href="daishenli.php"> <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span> 处理中案件</a></li>
		...
		<div id="container"> 
			<div id="right" style="background:#F7F8F9;min-height: 600px;">
			<br><br>
				 <h3><a href="daishenli.php"><b style="margin-left: 10px;">处理中案件</b></a></h3><hr>
				<table class="table table-bordered table-hover table-responsive"  style="margin:auto;width: 80%">
				<thead>
				<tr>
					<th style="text-align: center;width: 4%;">编号</th>
					<th style="width: 12%;text-align: center">姓名</th>
					<th style="width: 12%;text-align: center">手机号</th>
					<th style="text-align: center;width: 20%">投诉主题</th>
					<th style="width: 16%;text-align: center">投诉时间</th>
					<th style="text-align: center;width: 8%">详情</th>
					<th style="width: 8%;text-align: center">权限</th>
				</tr>
				</thead>
				<?php
				$host="localhost";
				...
				$sql="select * from information where state='处理中' limit $offset,$pageSize";
				...
				while(@$row=mysql_fetch_assoc($result)){
					if($row['state']=="处理中"){
						$j++;
						echo "<tr>";
						echo "<td style='text-align: center;width: 4%;'>{$j}</td>";
						echo "<td style='text-align: center;width: 12%;'>{$row['name2']}</td>";
						echo "<td style='text-align: center;width: 12%'>{$row['phone']}</td>";
						echo "<td style='text-align: center;width: 20%'>{$row['topic']}</td>";
						echo "<td style='text-align: center;width: 16%'>{$row['date']}</td>";
						if(!empty($_GET['p'])){
							echo "<td style='text-align: center;width: 8%'><a href='all_content2.php?id=".$row['id']."&p=".$_GET['p']."'>查看详情</a></td>";
							echo "<td style='text-align: center;width: 8%'><a href='delete1.php?id=".$row['id']."&p=".$_GET['p']."'>删除</a></td>";
						}else{
							echo "<td style='text-align: center;width: 8%'><a href='all_content2.php?id=".$row['id']."'>查看详情</a></td>";
							echo "<td style='text-align: center;width: 8%'><a href='delete1.php?id=".$row['id']."'>删除</a></td>";
						}
				...
				$total_sql = "select COUNT(*) from information where state='处理中'";
				...
				$page_banner.="<form action='daishenli.php' method='get'>";
