            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                   <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a  style="font-size:16px;" href="finishedacse.php"> <span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span> 已完成案件</a></li>
                ...
                <tr>
                  <td rowspan="2" style="width:50%;">昵称：<?php echo $row['name1']?></td>
                     <td style="width:50%;">手机号码：<?php echo $row['phone']?></td>
						...
						<font style="font-size:18px;">回复内容：<?php echo $row['hf'] ?></font><br><br>
				</tr></td>
			</table>
			<br><br><br><br><br><br> 
			</div>
