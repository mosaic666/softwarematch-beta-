    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a  style="font-size:16px;" href="finishedacse.php"> <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span> 已完成案件</a></li>
		...
		<div id="container"> 
			<div id="right" style="background:#F7F8F9;min-height:700px;">
				<br><br>
				<h3><a href="finishedacse.php"> <b style="margin-left: 10px;">已完成案件</b></a></h3><hr>
				...
				<tr>
					...
					$sql="select * from information where state='已完成' limit $offset,$pageSize";
					...
					while(@$row=mysql_fetch_assoc($result)){
						if($row['state']=="已完成"){
							...
							if(!empty($_GET['p'])){
								echo "<td style='text-align: center;width: 8%'><a href='all_content1.php?id=".$row['id']."&p=".$_GET['p']."'>查看详情</a></td>";
								echo "<td style='text-align: center;width: 8%'><a href='delete2.php?id=".$row['id']."&p=".$_GET['p']."'>删除</a></td>";
							}else{
								echo "<td style='text-align: center;width: 8%'><a href='all_content1.php?id=".$row['id']."'>查看详情</a></td>";
								echo "<td style='text-align: center;width: 8%'><a href='delete2.php?id=".$row['id']."'>删除</a></td>";
							}
					...
					$total_sql = "select COUNT(*) from information where state='已完成'";
					...
					$page_banner.="<form action='finishedacse.php' method='get'>";
