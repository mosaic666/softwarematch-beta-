...
if(!$conn){
    ...
    $sql =  @mysql_query("select * from informatiom WHERE phone ='17865313062'" );
    ...
    <div id="main-wrapper">
        ...
        <div id="container"> 
         <div id="right" style="background:#F7F8F9">
            <br><br>
            <h3><b style="margin-left: 10px;">案例详情</b></h3><hr>
            <div id="" style="margin:auto;font-size:18px;">
               <table class="table table-hover table-bordered table-responsive"  style="margin:auto;width: 80%;font-size: 14px;color: black">
                ...
                <tr>
                    <td rowspan="2" style="width:50%;">真实姓名：<?php echo $row['name2']?></td>
                ...
                <tr><td colspan="2" style="width:100%;">  <br>
                 <form action="../../../mail.php?id=<?php echo $id?>" method="post">
                     <font style="font-size:18px;"><b>请输入回复内容：</b></font><br><br>
                     <textarea style="margin-left:10%;background:#FFFFFF;width:70%;min-height:150px;"  name="hf" > </textarea><br><br>
                     <input class="btn btn-info pull-right" style="margin-right:15%;min-width:15%" type="submit" name="" value="回复并完成"><br><br><br>
                 </form>
             </td>
         </tr>
     </table>    				
